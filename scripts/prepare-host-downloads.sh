...
PAYLOAD_URL="$(beagle_public_release_artifact_url "$PUBLIC_ARTIFACT_BASE_URL" "pve-thin-client-usb-payload-latest.tar.gz")"
BOOTSTRAP_URL="$(beagle_public_release_artifact_url "$PUBLIC_ARTIFACT_BASE_URL" "pve-thin-client-usb-bootstrap-latest.tar.gz")"
...
SHA256SUMS_URL="$(beagle_public_release_artifact_url "$PUBLIC_ARTIFACT_BASE_URL" "SHA256SUMS")"
SERVER_INSTALLER_ISO_URL="$(beagle_public_release_artifact_url "$PUBLIC_ARTIFACT_BASE_URL" "beagle-os-server-installer-amd64.iso")"
