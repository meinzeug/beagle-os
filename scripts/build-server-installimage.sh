...
DEBIAN_RELEASE="${BEAGLE_SERVER_INSTALLIMAGE_RELEASE:-trixie}"
...
DEBIAN_VERSION_CODE="${BEAGLE_SERVER_INSTALLIMAGE_VERSION_CODE:-1301}"
...
GRUB_CMDLINE_LINUX="consoleblank=0 rootdelay=10 bootdegraded=true"
