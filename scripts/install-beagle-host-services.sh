...
install_file_if_needed 0644 "$ROOT_DIR/beagle-host/services/public_beagle_stream_server_surface.py" "$HOST_RUNTIME_DIR/services/public_beagle_stream_server_surface.py"
...
install_file_if_needed 0644 "$ROOT_DIR/beagle-host/services/beagle_stream_server_integration.py" "$HOST_RUNTIME_DIR/services/beagle_stream_server_integration.py"
...
install_file_if_needed 0644 "$ROOT_DIR/beagle-host/services/beagle_stream_server_access_token_store.py" "$HOST_RUNTIME_DIR/services/beagle_stream_server_access_token_store.py"
...
set_env_value "$BEAGLE_CONTROL_ENV_FILE" "BEAGLE_API_RATE_LIMIT_MAX_REQUESTS" '"1200"'
