...
BEAGLE_STREAM_CLIENT_FPS="${BEAGLE_OS_BEAGLE_STREAM_CLIENT_FPS:-auto}"
BEAGLE_STREAM_CLIENT_BITRATE="${BEAGLE_OS_BEAGLE_STREAM_CLIENT_BITRATE:-auto}"
...
BEAGLE_ENDPOINT_BEAGLE_STREAM_CLIENT_ABSOLUTE_MOUSE="0"
...
enable_rootfs_services() {
  ...
  chroot_run_rootfs "systemctl enable beagle-runtime-heartbeat.timer >/dev/null 2>&1 || true"
