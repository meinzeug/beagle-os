...
def _build_vm_catalog_entry(
    *,
    ...
    preset = {
        ...
        "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_FPS": stream_meta.get("beagle-stream-client-fps", "auto"),
        "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_BITRATE": stream_meta.get("beagle-stream-client-bitrate", "auto"),
