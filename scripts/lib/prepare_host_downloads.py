...
def _build_vm_catalog_entry(
    *,
    ...
    preset = {
        ...
        "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_BITRATE": stream_meta.get("beagle-stream-client-bitrate", "32000"),
        "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_VIDEO_CODEC": stream_meta.get("beagle-stream-client-video-codec", "H.264"),
        "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_VIDEO_DECODER": stream_meta.get("beagle-stream-client-video-decoder", "software"),
...
def write_download_status(
    *,
    ...
    payload = {
        ...
        "bootstrap_filename": payload_path.name,
