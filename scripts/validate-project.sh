...
node --check "$ROOT_DIR/providers/beagle/virtualization-provider.js"
...
node --check "$ROOT_DIR/extension/shared/vm-profile-mapper.js"
node --check "$ROOT_DIR/extension/shared/vm-profile-helpers.js"
node --check "$ROOT_DIR/proxmox-ui/components/ui-helpers.js"
node --check "$ROOT_DIR/proxmox-ui/components/modal-shell.js"
...
node --check "$ROOT_DIR/proxmox-ui/components/extjs-integration.js"
...
node --check "$ROOT_DIR/extension/components/profile-modal.js"
