...
2. Continue decomposing `beagle-host/bin/beagle-control-plane.py` around service-oriented modules:
   ...
   - the next valuable host slice is the next public/install or update-feed/authenticated handler cluster that still sits directly in `beagle-control-plane.py`, not another tiny utility
