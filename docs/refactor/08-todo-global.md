...
- [ ] Re-run standalone `scripts/check-beagle-host.sh` after the active `srv1` repo-auto-update build is idle; it should pass without PVE service checks, stale `8443` references, or status checksum drift.
