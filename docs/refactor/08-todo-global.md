...
- [ ] Close the final GoFuture Plan 10 entitlement visibility checkbox by implementing or proving user-facing pool filtering in addition to the existing `403 not entitled to this pool` allocate guard.
