...
Betroffene Verzeichnisse: `core/`, `providers/`, `beagle-host/providers/`, `proxmox-ui/`  
...
Proxmox-Provider implementieren damit Services ohne Anpassung zwischen Providern wechseln.
