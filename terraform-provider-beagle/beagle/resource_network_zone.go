...
func resourceNetworkZoneCreate(ctx context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
...
func resourceNetworkZoneRead(_ context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
...
func resourceNetworkZoneUpdate(ctx context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
	payload := map[string]any{}
...
func resourceNetworkZoneDelete(_ context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
