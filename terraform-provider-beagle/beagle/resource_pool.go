...
func resourcePoolCreate(ctx context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
...
func resourcePoolRead(_ context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
...
func resourcePoolUpdate(ctx context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
	payload := map[string]any{}
	if d.HasChange("name") {
...
func resourcePoolDelete(_ context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
