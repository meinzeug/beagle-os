...
func resourceUserCreate(ctx context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
...
func resourceUserRead(_ context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
...
func resourceUserUpdate(ctx context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
	payload := map[string]any{}
...
func resourceUserDelete(_ context.Context, d *schema.ResourceData, m any) error {
	client := m.(*Client)
