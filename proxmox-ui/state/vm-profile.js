  ...
  function resolveVmProfile(ctx) {
    return Promise.all([
      ...
      var profile = {
        ...
        installerUrl: controlPlaneProfile && controlPlaneProfile.installer_url || common.resolveUsbInstallerUrl(ctx),
        ...
        installerIsoUrl: controlPlaneProfile && controlPlaneProfile.installer_iso_url || common.resolveInstallerIsoUrl(ctx),
        controlPlaneHealthUrl: common.resolveControlPlaneHealthUrl(),
        managerUrl: common.managerUrlFromHealthUrl(common.resolveControlPlaneHealthUrl()),
