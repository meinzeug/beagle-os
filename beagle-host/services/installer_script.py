    ...
    def build_preset(
        ...
        *,
        ...
        return build_common_preset(
            ...
            beagle_stream_client_fps=str(profile.get("beagle_stream_client_fps", "auto") or "auto"),
            beagle_stream_client_bitrate=str(profile.get("beagle_stream_client_bitrate", "auto") or "auto"),
