    ...
    def build_preset(
        ...
        *,
        ...
        return build_common_preset(
            ...
            beagle_stream_client_resolution=str(profile.get("beagle_stream_client_resolution", "1280x720") or "1280x720"),
            beagle_stream_client_fps=str(profile.get("beagle_stream_client_fps", "30") or "30"),
            beagle_stream_client_bitrate=str(profile.get("beagle_stream_client_bitrate", "6000") or "6000"),
