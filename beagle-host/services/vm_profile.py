...
class VmProfileService:
    ...
    def build_profile(self, vm: Any, *, allow_assignment: bool = True) -> dict[str, Any]:
        ...
        profile = {
            ...
            "beagle_stream_client_resolution": policy_profile.get("beagle_stream_client_resolution") or meta.get("beagle-stream-client-resolution", "1920x1080"),
            "beagle_stream_client_fps": policy_profile.get("beagle_stream_client_fps") or meta.get("beagle-stream-client-fps", "60"),
            "beagle_stream_client_bitrate": policy_profile.get("beagle_stream_client_bitrate") or meta.get("beagle-stream-client-bitrate", "32000"),
            ...
            "beagle_stream_client_video_decoder": policy_profile.get("beagle_stream_client_video_decoder") or meta.get("beagle-stream-client-video-decoder", "software"),
            ...
            "beagle_guest_updater": policy_profile.get("beagle_guest_updater") or meta.get("beagle-guest-updater", ""),
