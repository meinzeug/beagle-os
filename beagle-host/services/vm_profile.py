...
class VmProfileService:
    ...
    def build_profile(self, vm: Any, *, allow_assignment: bool = True) -> dict[str, Any]:
        ...
        profile = {
            ...
            "beagle_stream_client_fps": policy_profile.get("beagle_stream_client_fps") or meta.get("beagle-stream-client-fps", "auto"),
            "beagle_stream_client_bitrate": policy_profile.get("beagle_stream_client_bitrate") or meta.get("beagle-stream-client-bitrate", "auto"),
