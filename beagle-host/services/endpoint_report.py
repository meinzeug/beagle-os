...
class EndpointReportService:
    ...
    def summarize(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            ...
            "beagle_stream_client_port": payload.get("beagle_stream_client_port", ""),
            "beagle_stream_client_app": payload.get("beagle_stream_client_app", ""),
            ...
            "beagle_stream_client_target_reachable": health.get("beagle_stream_client_target_reachable", ""),
            "beagle_stream_server_api_reachable": health.get("beagle_stream_server_api_reachable", ""),
            ...
            "update_health_failure": bool(update.get("health_failure", False)),
            "update_rollback_recommended": bool(update.get("rollback_recommended", False)),
            "update_last_health_failure_at": update.get("last_health_failure_at", ""),
            "update_client": update.get("client", ""),
            "update_client_version": update.get("client_version", ""),
            "update_path": update.get("update_path", ""),
            "update_self_update_supported": bool(update.get("self_update_supported", False)),
            "update_reboot_prompt": update.get("reboot_prompt", ""),
