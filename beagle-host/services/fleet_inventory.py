            ...
            inventory.append(
                {
                    ...
                    "beagle_stream_server_api_url": profile.get("beagle_stream_server_api_url", ""),
                    ...
                    "default_mode": "BEAGLE_STREAM_CLIENT" if profile.get("stream_host") else "",
                    ...
                    or (["BEAGLE_STREAM_CLIENT"] if profile["stream_host"] else []),
