(function() {
  ...
  function buildUiProfile(options) {
    ...
    return {
      ...
      beagle-stream-serverPin: credentials && credentials.beagle_stream_server_pin || "",
      ...
      bitrate: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_bitrate || commonData.meta["beagle-stream-client-bitrate"] || "20000",
      codec: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_video_codec || commonData.meta["beagle-stream-client-video-codec"] || "H.264",
      decoder: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_video_decoder || commonData.meta["beagle-stream-client-video-decoder"] || "auto",
      audio: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_audio_config || commonData.meta["beagle-stream-client-audio-config"] || "stereo",
      ...
      beagleHost: commonData.meta["beagle-host"] || options.host || window.location.hostname,
  ...
  function buildExtensionProfile(options) {
    ...
    return {
      ...
      beagle-stream-serverPin: commonData.meta["beagle-stream-server-pin"] || String(Number(ctx.vmid) % 10000).padStart(4, "0"),
      app: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_app || commonData.meta["beagle-stream-client-app"] || commonData.meta["beagle-stream-server-app"] || "Desktop",
      resolution: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_resolution || commonData.meta["beagle-stream-client-resolution"] || "auto",
      fps: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_fps || commonData.meta["beagle-stream-client-fps"] || "60",
      bitrate: controlPlaneProfile && controlPlaneProfile.beagle_stream_client_bitrate || commonData.meta["beagle-stream-client-bitrate"] || "20000",
