...
PRESET_TO_INSTALLER_ENV = {
    ...
    "MOONLIGHT_APP": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_APP",
    "MOONLIGHT_BIN": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_BIN",
    "MOONLIGHT_RESOLUTION": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_RESOLUTION",
    "MOONLIGHT_FPS": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_FPS",
    "MOONLIGHT_BITRATE": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_BITRATE",
    "MOONLIGHT_VIDEO_CODEC": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_VIDEO_CODEC",
    "MOONLIGHT_VIDEO_DECODER": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_VIDEO_DECODER",
    "MOONLIGHT_AUDIO_CONFIG": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_AUDIO_CONFIG",
    "MOONLIGHT_ABSOLUTE_MOUSE": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_ABSOLUTE_MOUSE",
    "MOONLIGHT_QUIT_AFTER": "PVE_THIN_CLIENT_PRESET_MOONLIGHT_QUIT_AFTER",
    "SUNSHINE_API_URL": "PVE_THIN_CLIENT_PRESET_SUNSHINE_API_URL",
    "PROXMOX_SCHEME": "PVE_THIN_CLIENT_PRESET_PROXMOX_SCHEME",
    "PROXMOX_HOST": "PVE_THIN_CLIENT_PRESET_PROXMOX_HOST",
    "PROXMOX_PORT": "PVE_THIN_CLIENT_PRESET_PROXMOX_PORT",
    "PROXMOX_NODE": "PVE_THIN_CLIENT_PRESET_PROXMOX_NODE",
    "PROXMOX_VMID": "PVE_THIN_CLIENT_PRESET_PROXMOX_VMID",
    "PROXMOX_REALM": "PVE_THIN_CLIENT_PRESET_PROXMOX_REALM",
    "PROXMOX_VERIFY_TLS": "PVE_THIN_CLIENT_PRESET_PROXMOX_VERIFY_TLS",
