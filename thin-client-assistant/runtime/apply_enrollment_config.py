...
def apply_enrollment_config(
    ...
    for key, value in (
        ...
        ("PVE_THIN_CLIENT_BEAGLE_AUDIO_INPUT_PORT", config.get("usb_audio_input_port", "")),
        ("PVE_THIN_CLIENT_BEAGLE_USB_EXTRA_REVERSE_FORWARDS", config.get("usb_extra_reverse_forwards", "")),
