...
PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_CONNECT_HOST="${PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_CONNECT_HOST:-}"
export PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_CONNECT_HOST
...
seed_beagle_stream_client_host_from_runtime_config() {
  ...
  if [[ -z "${PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_CONNECT_HOST:-}" && -n "${PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_LOCAL_HOST:-}" ]]; then
    PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_CONNECT_HOST="${PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_LOCAL_HOST:-}"
    export PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_CONNECT_HOST
  fi
