...
validate_beagle_stream_client_auto_pin_preset() {
  if [[ -z "${PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_HOST:-}" || -z "${PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_SERVER_USERNAME:-}" || -z "${PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_SERVER_PASSWORD:-}" || -z "${PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_SERVER_PIN:-}" ]]; then
