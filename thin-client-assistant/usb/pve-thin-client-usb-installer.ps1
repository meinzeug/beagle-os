...
function Write-LiveRuntimeState {
    ...
    try {
        ...
        $thinclientConf = @(
            ...
            ('PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_BITRATE="{0}"' -f (Get-PresetValue $preset "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_BITRATE" "32000"))
            ...
            ('PVE_THIN_CLIENT_BEAGLE_STREAM_CLIENT_VIDEO_DECODER="{0}"' -f (Get-PresetValue $preset "PVE_THIN_CLIENT_PRESET_BEAGLE_STREAM_CLIENT_VIDEO_DECODER" "software"))
