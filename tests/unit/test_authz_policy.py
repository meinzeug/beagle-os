...
class AuthzPolicyServiceTests(unittest.TestCase):
    ...
    def test_enterprise_scheduler_cost_and_energy_routes_use_settings_permissions(self):
        ...
        self.assertEqual(
            AuthzPolicyService.required_permission("GET", "/api/v1/energy/rankings"),
            "settings:read",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            AuthzPolicyService.required_permission("GET", "/api/v1/fleet/remediation/config"),
            "settings:read",
        )
        self.assertEqual(
            AuthzPolicyService.required_permission("GET", "/api/v1/fleet/remediation/history"),
            "settings:read",
        )
        self.assertEqual(
