...
def _make_endpoint_http_surface(
    *,
    ...
    return EndpointHttpSurfaceService(
        ...
        alert_service=None,
        exchange_beagle_stream_client_pairing_token=lambda _vm, _identity, _token: {"ok": True},
        fetch_beagle_stream_server_identity=lambda _vm, _guest_user: {},
        find_vm=lambda vmid: vm if int(vmid) == vm.vmid else None,
        issue_beagle_stream_client_pairing_token=lambda _vm, _identity, _device_name: {"ok": True, "token": "token", "pin": "1234"},
...
def _make_enrollment_service(tmp_path: Path) -> tuple[EndpointEnrollmentService, _Vm]:
    ...
    secret = {
        "beagle_stream_server_username": "sun",
        "beagle_stream_server_password": "pass",
        "beagle_stream_server_pin": "1234",
        "beagle_stream_server_pinned_pubkey": "pub",
    ...
    svc = EndpointEnrollmentService(
        ...
        resolve_vm_beagle_stream_server_pinned_pubkey=lambda _vm: "pub",
