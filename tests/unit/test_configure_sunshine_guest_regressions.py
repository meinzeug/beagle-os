...
def test_configure_sunshine_guest_disables_display_idle_and_lockers() -> None:
    ...
    assert '/home/$GUEST_USER/.config/autostart/light-locker.desktop' in content
    assert '/home/$GUEST_USER/.config/autostart/xfce4-power-manager.desktop' in content
    assert '/home/$GUEST_USER/.config/autostart/xfce4-screensaver.desktop' in content
